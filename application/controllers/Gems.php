...
class Gems extends CI_Controller {
	...
	public function manage(){
		$config["base_url"] = site_url()."/Gems/manage";
		$coutData = $this->db->from("Gems")->count_all_results();
		...
		$data['details'] = $this->db->query("select * from Gems order by id desc limit $npage,$p")->result_array();

		$data['active'] = 'Gems';

		$data['title'] = 'Manage Gems';

		$this->load->view('admin/includes/header',$data);

		$this->load->view('admin/Gems/manage');
