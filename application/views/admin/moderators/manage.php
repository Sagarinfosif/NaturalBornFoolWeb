		   ...
		   <!-- /.box -->
				<div class="box">
					<div class="box-header">
						<h3 class="box-title"><a href="<?= site_url();?>/Moderators/addModerators" style="font-size: 14px;" class="btn btn-block btn-success btn-xs">Add Moderators</a></h3>
					</div>
											...
											<li class="dropdown">
												...
												<ul class="dropdown-menu dropdown-menu-right">
													<li role="presentation">
														<a role="menuitem" tabindex="-1" href="<?= site_url()?>/Moderators/view/<?= $data['id'];?>">View</a>
													</li>
													<li role="presentation">
														<a role="menuitem" tabindex="-1" href="<?= site_url()?>/Moderators/edit/<?= $data['id'];?>">Edit</a>
													</li>
													<li>
														<a role="menuitem" tabindex="-1" onclick="return confirm(&quot;Once you've deleted 	this account, the moderators (<?php  echo $data['username'];?>) will no longer be able to log in to the site or apps. This action cannot be undone.&quot;);" href="<?= site_url()?>/Moderators/delete/<?= $data['id'];?>">Delete
											            </a>
													</li>
													<li role="presentation" class="divider"></li>	
											        <li role="presentation">
														<a role="menuitem" onclick="return confirm(<?php  echo $data['username'];?> - Do you want <?php if($data['status'] == 'Approved'){ echo "Decline"; } else{ echo "Approve";}?> this moderators&quot;);" tabindex="-1" href="<?= site_url()?>/Moderators/status/<?= $data['id'];?>">
...
<script>
	 ...
	 $("#search").click(function(){
    	...
    	$.ajax({
    		type:"post",
   			url:"<?= site_url()?>/moderators/getResult",
            ...
            if(data ==''){
                ...
                for(var i = 0; i < data.length; i++) {
                    ...
                    '</td><td>' + "" + '</td><td>' + "0" + '</td><td><span class="label label-success">' + comment.status + 
