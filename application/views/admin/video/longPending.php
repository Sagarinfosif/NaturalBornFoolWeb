		...
		<div class="row">
          ...
          <div class="main-data">
            <div class="col-md-12 filter_form" style="margin-left:60px;margin-top:10px;margin-bottom:20px">
              <form method="post" action="<?= site_url()."/videos/getlongPendingVideoResult";?>" id="getPdf">
                <div class = "row">
                  <div class="col-md-2">
                ...
                <th>Video</th>
                  ...
                  <th><?php echo $data['id']?></th>
                          ...
                          if(!empty($data['hashtags'])) { ?>
                             	<a role="menuitem" tabindex="-1" href="<?= site_url()?>/Videos/pendingView/<?php echo  $data['id'];?>/6">
