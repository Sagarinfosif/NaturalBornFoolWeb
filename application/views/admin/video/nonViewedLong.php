		...
		<div class="row">
          ...
          <div class="main-data">
            <div class="col-md-12 filter_form" style="margin-left:60px;margin-top:10px;margin-bottom:20px">
              <form method="post" action="<?= site_url()."/videos/getLongnonViewedVideoApprovedResult";?>" id="getPdf">
                <div class = "row">
                  <div class="col-md-2">
                        ...
                        $a = explode(',',$data['hashTag']);
                         $count = count($a);
                          if(!empty($data['hashtags'])) { ?>
                              <a role="menuitem" tabindex="-1" href="<?= site_url()?>/Videos/pendingView/<?php echo  $data['id'];?>/5">
