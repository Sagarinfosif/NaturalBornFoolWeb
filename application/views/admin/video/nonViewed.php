		...
		<div class="row">
          ...
          <div class="main-data">
            <div class="col-md-12 filter_form" style="margin-left:60px;margin-top:10px;margin-bottom:20px">
              <form method="post" action="<?= site_url()."/videos/getnonViewedVideoApprovedResult";?>" id="getPdf">
                <div class = "row">
                  <div class="col-md-2">
            ...
            <button type="button" class="btn btn-warning" name="trendingBtn" id="trendVideo" >Trending</button>
            <button type="button" class="btn btn" name="ViewedBtn" id="ViewedVideo" style="background-color: green; color: white" >Viewed</button>
                ...
                <th>Video</th>
                  ...
                  <th><?php echo $data['id']?></th>
                          ...
                          if(!empty($data['hashtags'])) { ?>
                            <a role="menuitem" tabindex="-1" href="<?= site_url()?>/Videos/pendingView/<?php echo  $data['id'];?>/3">
...
$("#trendVideo").click(function(){
  ...
  var id = m.join(',');
   //alert(id);
  $.ajax({
    url:"<?php echo site_url() ?>/Videos/trendingStatus",
    type:"post",
    data:{id:id},
    success: function (data) {
      //alert(data);
 ...
 // alert(id);
  $.ajax({
    url:"<?php echo site_url() ?>/Videos/viewedStatus",
    type:"post",
    data:{id:id},
    success: function (data) {
     // alert(data);
