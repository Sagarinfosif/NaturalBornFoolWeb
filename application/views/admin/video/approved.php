		   ...
		   <!-- /.box -->
                ...
                <div class="main-data">
                    ...
                    <td><?php  echo $data['description'];?></td>
  									<td>
  										<a href="<?= site_url()?>/Videos/pendingView/<?php echo  $data['id'];?>/1">
...
<script>
	 ...
	 $("#search").click(function(){
    	...
    	$.ajax({
    		type:"post",
   			url:"<?= site_url()?>/videos/getapprResult",
            ...
            if(data ==''){
                ...
                for(var i = 0; i < data.length; i++) {
                    ...
                    '</td><td>' + comment.hash + '</td><td>' + comment.description + '</td><td><a href="<?= site_url()?>/Videos/pendingView/<?php echo  $data['id'];?>/1"><i class="fa fa-eye" style="font-size: 22px;">' + "" + '</i></a></td></tr>';
            	}
