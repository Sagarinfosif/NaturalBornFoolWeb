...
<div class="content-wrapper">
	...
	<section class="content-header">
		...
		<ol class="breadcrumb">
			...
			<li><a href="<?php echo site_url();?>/videos/adminVideo"><i class="fa fa-video"></i> Admin Video</a></li>
								...
								<tr>
									...
									<td>
										<?php if(!empty($data['image'])){?>
											<img style="width:90px;height:80px" src="<?php echo $data['image'];?>">
										<?php } else{?>
											<img style="width:90px;height:80px" src="<?php echo base_url();?>uploads/no_image_available.png">
										<?php } ?>
									</td>
