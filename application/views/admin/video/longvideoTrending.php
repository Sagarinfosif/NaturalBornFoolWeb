	...
	<section class="content">
		<div class="row">
          ...
          <div class="main-data">
              ...
              <form method="post" action="<?= site_url()."/videos/getLongTrendingVideoApprovedResult";?>" id="getPdf">
              	<div class = "row">
			            <div class="col-md-2">
                ...
                <th>Video</th>
                  ...
                  <td><?php
                            ...
                            if(!empty($data['hashtags'])) { ?>
                                <a role="menuitem" tabindex="-1" href="<?= site_url()?>/Videos/pendingView/<?php echo  $data['id'];?>/7">
