		   ...
		   <!-- /.box -->
				<div class="box">
					<div class="box-header">
						<h3 class="box-title"><a href="<?= site_url();?>/User/sendMessage" style="font-size: 14px;" class="btn btn-block btn-success btn-xs">Send Message</a></h3>
					</div>
						...
						<table id="example1" class="table table-bordered table-striped">
							...
							<?php $i = 1; foreach($details as $data){ ?>
								<tr>
									...
									<td><?php  echo ($data['user_type']== 1)? "All Users":"Single User" ?></td>
