		   ...
		   <!-- /.box -->
				<div class="box">
					<div class="box-header">
						<h3 class="box-title"><a href="<?= site_url();?>/Badges/add" style="font-size: 14px;" class="btn btn-block btn-success btn-xs">Add Crown</a></h3>
					</div>
											...
											<li class="dropdown">
												...
												<ul class="dropdown-menu dropdown-menu-right">
													<li role="presentation">
														<a role="menuitem" tabindex="-1" href="<?= site_url()?>/Badges/edit/<?php echo  $data['id'];?>">Edit</a>
													</li>
													<li>
														<a role="menuitem" tabindex="-1" href="<?= site_url()?>/Badges/delete/<?php echo  $data['id'];?>">Delete </a>
													</li>
												</ul>
											</li>
										</ul>
